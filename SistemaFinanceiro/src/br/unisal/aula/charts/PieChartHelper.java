...
import static br.unisal.aula.charts.BarChartHelper.criarGrafico;
...
public class PieChartHelper {
    ...
    public static JFreeChart criarGrafico(ArrayList<ItemFinanceiro> lista, String[] categorias) {
        // Chave --> Valor
        ...
        PieSectionLabelGenerator label
    ...
    public static void save(String nomeArquivo, ArrayList<ItemFinanceiro> lista, String[] categorias) {
